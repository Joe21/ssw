...
smoke_wednesday = Smoke.create(quantity: 15, date: Time.now - 1.day)
sleep_wednesday = Sleep.create(hours_slept: 2, date: Time.now - 2.day)
joe.smokes << smoke_wednesday
joe.sleeps << sleep_wednesday

smoke_tuesday = Smoke.create(quantity: 13, date: Time.now - 2.day)
sleep_tuesday = Sleep.create(hours_slept: 3, date: Time.now - 3.day)
joe.smokes << smoke_tuesday
joe.sleeps << sleep_tuesday

smoke_monday = Smoke.create(quantity: 10, date: Time.now - 3.day)
sleep_monday = Sleep.create(hours_slept: 3.5, date: Time.now - 4.day)
